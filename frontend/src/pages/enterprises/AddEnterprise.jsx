...
const AddEnterprise = () => {
  ...
  const { addEnterprise, loading, clearError } = useEnterpriseContext();
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await addEnterprise(submitData);

    if (result.data) {
      toast.success(result.success || "Enterprise added successfully!", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    <div className='mx-auto max-w-4xl px-4 py-8 bg-gray-50 min-h-screen'>
      <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6">
          <h1 className='text-3xl font-bold text-white text-center'>Add New Enterprise</h1>
          <p className="text-blue-100 text-center mt-2">Fill in the details below to register a new enterprise</p>
        </div>
